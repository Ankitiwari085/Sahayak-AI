      ...
      >
        <div className={`auth-inner relative w-full h-full transition-transform duration-700 ${isSignup ? "flipped" : ""}`} style={{ minHeight: 420 }}>
          ...
          <div className="auth-face auth-front absolute inset-0 bg-white rounded-xl shadow-xl p-8">
            ...
            <input type="email" className="w-full bg-gray-50 border border-gray-300 rounded-md px-3 py-2 mb-4 mt-1 text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-200" placeholder="you@example.com" />

            <label className="block text-sm text-gray-700">Password</label>
            <input type="password" className="w-full bg-gray-50 border border-gray-300 rounded-md px-3 py-2 mb-6 mt-1 text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-200" placeholder="••••••••" />

            <button onClick={() => { onLogin && onLogin({ name: 'User', email: 'user@example.com' }); onClose(); }} className="w-full bg-blue-600 text-white py-2 rounded-md font-medium mb-3">Log In</button>
          ...
          {/* Back - Signup */}
          <div className="auth-face auth-back absolute inset-0 bg-white rounded-xl shadow-xl p-8">
            ...
            <label className="block text-sm text-gray-700">Email</label>
            <input type="email" className="w-full bg-gray-50 border border-gray-300 rounded-md px-3 py-2 mb-4 mt-1 text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-100" placeholder="you@example.com" />
        ...
        <button onClick={onClose} className="absolute -top-3 -right-3 bg-white rounded-full p-2 shadow">✕</button>
      </div>
    </div>
  );
}
