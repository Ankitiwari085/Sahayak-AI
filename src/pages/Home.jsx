...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      {/* Main Home Section */}
      <main className="flex-grow flex flex-col lg:flex-row justify-between items-center px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24 py-16 sm:py-20 md:py-24 mt-4 sm:mt-6 md:mt-8 gap-8 lg:gap-12">
        {/* 👆 Responsive padding and spacing */}

        <div className="max-w-xl w-full lg:w-1/2 text-center lg:text-left">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-4 sm:mb-6 md:mb-8">Simple, Fast, and Free</p>
          <p className="text-sm sm:text-base text-gray-500 mb-6 sm:mb-8 md:mb-10">
  ...
  <button onClick={()=>{ if(!user) { openAuth(); } else { setShowVoiceModal(true); } }} className="flex items-center justify-center px-4 sm:px-5 py-3 bg-gradient-to-r from-teal-500 to-green-500 text-white rounded-lg text-sm sm:text-base font-semibold hover:opacity-90 transition w-full sm:w-auto">
      <Mic className="w-4 h-4 sm:w-5 sm:h-5 mr-2" />
      Start with Voice
    </button>

    <button onClick={()=>{ if(!user) { openAuth(); } else { navigate('/chat'); } }} className="flex items-center justify-center px-4 sm:px-5 py-3 border-2 border-blue-500 text-blue-600 rounded-lg text-sm sm:text-base font-semibold hover:bg-blue-50 transition w-full sm:w-auto">
      ...
      />
        ...
        <div className="mt-8 lg:mt-0 lg:w-1/2 flex justify-center w-full px-4 sm:px-0">
          <img
            src={resumeImg}
            alt="Workers using AI"
            className="rounded-2xl shadow-lg w-full max-w-[300px] sm:max-w-[400px] md:max-w-[500px] lg:max-w-[650px] h-auto"
          />
        </div>
      </main>

      {/* Features Section */}
      <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20 border-t-2 border-gray-200 dark:border-slate-00">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl p-4 sm:p-5 md:p-6 shadow-md border border-gray-200 hover:shadow-lg transition-all hover:-translate-y-1"
              style={{ animationDelay: `${index * 0.1}s` }}
            >
              <div className="bg-blue-100 w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center mb-3 sm:mb-4">
      ...
      <section id="services" className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20 transition-colors border-t-2 border-gray-200 dark:border-slate-700">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            >
              <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center text-white text-2xl sm:text-3xl mx-auto shadow-lg">
                🛠️
              </div>
            </motion.div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 sm:mb-6">
  <span className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-blue-500">Our</span>{' '}
  <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
    Services
  </span>
</h2>

            <p className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-black-300 max-w-3xl mx-auto leading-relaxed px-4">
          ...
          >
            ...
            <motion.div
              ...
              className="group relative bg-white dark:bg-slate-800 rounded-3xl p-6 sm:p-7 md:p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-blue-300"
            >
              ...
              <div className="relative">
                <div className="w-16 h-16 sm:w-18 sm:h-18 md:w-20 md:h-20 bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl flex items-center justify-center mb-4 sm:mb-5 md:mb-6 group-hover:rotate-12 group-hover:scale-110 transition-transform duration-300 shadow-xl">
                  <MdBuild className="text-white text-3xl sm:text-4xl" />
                </div>
                <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-gray-900 dark:text-white">AI Resume Builder</h3>
                <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4 sm:mb-5 md:mb-6 font-medium">
                ...
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm text-gray-800 dark:text-gray-300 bg-white/80 dark:bg-slate-700/50 p-1.5 sm:p-2 rounded-lg">
